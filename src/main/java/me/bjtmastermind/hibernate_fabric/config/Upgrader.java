...
public class Upgrader {
    ...
    public static void upgrade() {
        ...
        Integer fireSpreadRadiusAroundPlayer = restoreGameRulesAs.has("fireSpreadRadiusAroundPlayer") ? restoreGameRulesAs.get("fireSpreadRadiusAroundPlayer").getAsInt() : null;
